...
public class MQTTService extends Service implements MqttSimpleCallback {
    ...
    private String mqttClientId = UUID.randomUUID().toString().substring(0, 22);
    ...
    public void onCreate() {
        ...
        brokerHostName = settings.getString("broker", "test.mosquitto.org");
        topicName = settings.getString("topic", "testFooBar");
    ...
    public void publishArrived(String topic, byte[] payloadbytes, int qos, boolean retained) {
        ...
        if (addReceivedMessageToStore(topic, messageBody)) {
            ...
            App.log.info("topic: " + topic + ", messageBody: " + messageBody);
    ...
    private void defineConnectionToBroker(String brokerHostName) {
        ...
        try {
            ...
            App.log.error("Exception while createMqttClient(): " + mqttConnSpec, e);
    ...
    private boolean connectToBroker() {
        ...
        try {
            ...
            App.log.error("Exception during connect.", e);
    ...
    private void subscribeToTopic(String topicName) {
        ...
        if (isAlreadyConnected() == false) {
            ...
            App.log.error("Unable to subscribe as we are not connected");
        } else {
            try {
                ...
                App.log.error("subscribe failed - MQTT not connected", e);
            } catch (IllegalArgumentException e) {
                App.log.error("subscribe failed - illegal argument", e);
            } catch (MqttException e) {
                App.log.error("subscribe failed - MQTT exception", e);
            }
        }
    ...
    private void disconnectFromBroker() {
        ...
        try {
            if (netConnReceiver != null) {
                App.log.info("Unregistering CONNECTIVITY_ACTION receiver");
            ...
            App.log.error("unregister failed", eee);
        }
        ...
        try {
            ...
            App.log.error("disconnect failed - persistence exception", e);
        } finally {
            mqttClient = null;
        }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            try {
                ...
                try {
                    ...
                    App.log.error("disconnect failed - persistence exception", e1);
                }
